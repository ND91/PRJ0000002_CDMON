...
##ggplot
Cairo(file = "dmps_CDvHC_volcanoBeta_enlarged_ggplot.svg", type = "svg", units = "px", width = 700, height = 800, dpi = 90, bg = "white")
ggplot(volplot, aes(x = Coef, y = -log10(Padj), color = threshold)) + 
